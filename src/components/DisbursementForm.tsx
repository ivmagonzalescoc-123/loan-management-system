...
export function DisbursementForm({ application, onClose, onDisburse }: DisbursementFormProps) {
  ...
  const handleDisburse = async () => {
    ...
    if (isDisbursed) {
      alert('This application has already been disbursed.');
      return;
    }
      ...
      return;
                ...
                {!isDisbursed ? (
                  ...
                  <div className="p-4 bg-gray-50 border border-gray-200 rounded">
                    <div className="text-sm text-gray-700">This application is already disbursed. Authorization code is not required.</div>
                  </div>
                )}
        ...
        <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 p-6 flex justify-between">
          ...
          {step < 3 ? (
            ...
            isDisbursed ? (
              <button
                disabled
                className="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg cursor-not-allowed flex items-center gap-2"
              >
